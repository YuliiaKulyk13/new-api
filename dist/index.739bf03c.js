...
var _getUserApi = require("./getUserApi");
var _getUserApiDefault = parcelHelpers.interopDefault(_getUserApi);
var _renderUserCard = require("./renderUserCard");
var _renderUserCardDefault = parcelHelpers.interopDefault(_renderUserCard);
const btn = document.querySelector(".get-users-btn");
const userContainer = document.querySelector(".user-container");
function onClickUsers(e) {
    userContainer.innerHTML = "";
    (0, _getUserApiDefault.default)().then((usersData)=>{
        usersData.map((userData)=>{
            (0, _renderUserCardDefault.default)(userData);
        });
    }).catch((error)=>{
        console.log(error);
    });
...
},{"./getUserApi":"dCoAJ","./renderUserCard":"kc7BC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dCoAJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kc7BC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const userContainer = document.querySelector(".user-container");
